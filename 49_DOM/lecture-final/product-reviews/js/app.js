...
function setPageTitle() {
  ...
  //I 100% control name and the text, so innerHTML is ok.
  //titleSpan.innerHTML = name;
  // this is safer
  const emElement = document.createElement("em");
  emElement.innerText = name;
  titleSpan.insertAdjacentElement("afterbegin",emElement);
}
...
function displayReviews() {
  ...
  reviews.forEach((reviewItem) => {
    ...
    addReviewer(container,reviewItem.reviewer);
    addRating(container,reviewItem.rating);
    addTitle(container,reviewItem.title);
    addReview(container,reviewItem.review);
    //container.innerText = reviewItem.title + " -- debug --";
